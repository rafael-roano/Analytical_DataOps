import initial_data_extraction as d
import pandas as pd
import logging
import pytest
import sys
...
def test_reduce_so_table(spark_session, caplog):
    ...
    assert f"Table 'so' was successfully reduced to required fields: 9. Date range applied is: 2021-01-01 00:00:00 - 2021-12-31 23:59:59. Row count is 7." in caplog.text
