...
'''
Module to download csv files (transactional data) from s3 bucket and save them in local machine.
'''
...
s3.meta.client.download_file("aaa-raw-data", "customfield.csv", "/home/jv/Python/SB/SB_Projects/Open-ended_Capstone/data/customfield.csv")
print("customfield.csv successfully downloaded to local machine from aaa-raw-data bucket")
