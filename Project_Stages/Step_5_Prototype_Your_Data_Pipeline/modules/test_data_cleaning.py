...
def test_round_part_dims(spark_session, caplog):
    ...
    # Input and expected output dataframes
    input = spark_session.createDataFrame(
        [(2, 19.500000000, 10.000000000, 10, 22.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX4'),
         (3, 19.500000000, 10.000000000, 10, 22.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX5'),
         (4, 30.000000000, 8.000000000, 10, 24.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX6'),
         (5, 30.000000000, 8.000000000, 10, 24.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX7'),
         (6, 20.000000000, 15.000000000, 10, 15.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX8'),                     
         (7, 20.000000000, 15.000000000, 10, 15.000000000, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX9')],
    ...
    # Actual output dataframe
    actual_output = d.round_part_dims(df_name, input)
    ...
    assert f"Transformation on DataFrame '{df_name}' completed: Columns: len, width and height were rounded to 2 digits. Row count is 6" in caplog.text
...
def test_create_dim_products(spark_session, caplog):
    ...
    expected_output = spark_session.createDataFrame(
         [(2, 'R_6XXX4', 10.00, 22.00, 19.50),
         (3, 'R_6XXX5', 10.00, 22.00, 19.50),
         (4, 'R_6XXX6', 8.00, 24.00, 30.00),
         (5, 'R_6XXX7', 8.00, 24.00, 30.00),
         (6, 'R_6XXX8', 15.00, 15.00, 20.00),                     
         (7, 'R_6XXX9', 15.00, 15.00, 20.00)],
        ['id', 'masked_num', 'len_r', 'width_r', 'height_r'],
    )
