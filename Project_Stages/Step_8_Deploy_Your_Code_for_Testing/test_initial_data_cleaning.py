import initial_data_cleaning as d
...
def test_calculate_part_volume(spark_session, caplog):
    ...
    # Input and expected output dataframes
    input = spark_session.createDataFrame(
         [(2, 19.50, 10.00, 10, 22.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX4', '2019', 'FW', 'Grass'),
         (3, 19.50, 10.00, 10, 22.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX5', '2020', 'FW', 'Wood'),
         (4, 30.00, 8.00, 10, 24.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX6', '2021', 'SS', 'Wood'),
         (5, 30.00, 8.00, 10, 24.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX7', '2018', 'Custom', 'Grass'),
         (6, 20.00, 15.00, 10, 15.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX8', '2021', 'SS', 'Wood'),                     
         (7, 20.00, 15.00, 10, 15.00, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX9', '2021', 'SS', 'Wood')],
        ['id', 'height', 'len', 'typeId', 'width', 'customFields', 'masked_num', 'design_year', 'season', 'material'],
    )


    expected_output = spark_session.createDataFrame(
         [(2, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX4', '2019', 'FW', 'Grass', float(4290)),
         (3, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX5', '2020', 'FW', 'Wood', float(4290)),
         (4, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX6', '2021', 'SS', 'Wood', float(5760)),
         (5, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX7', '2018', 'Custom', 'Grass', float(5760)),
         (6, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX8', '2021', 'SS', 'Wood', float(4500)),                     
         (7, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX9', '2021', 'SS', 'Wood', float(4500))],
        ['id', 'typeId', 'customFields', 'masked_num', 'design_year', 'season', 'material', 'volume'],
    )

    # Actual output dataframe
    actual_output = d.calculate_part_volume(input)
    ...
    assert f"Transformation on DataFrame 'part' completed: part volume calculated. Row count is 6" in caplog.text
...
def test_create_dim_products(spark_session, caplog):
    ...
    # Input and expected output dataframes
    input = spark_session.createDataFrame(
         [(2, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX4', '2019', 'FW', 'Grass', 4290),
         (3, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX5', '2020', 'FW', 'Wood', 4290),
         (4, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX6', '2021', 'SS', 'Wood', 5760),
         (5, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX7', '2018', 'Custom', 'Grass', 5760),
         (6, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX8', '2021', 'SS', 'Wood', 4500),                     
         (7, 10, '{"1": {"name": "Country of Origin", "type": "Drop-Down List", "value": "Rwanda"}}', 'R_6XXX9', '2021', 'SS', 'Wood', 4500)],
        ['id', 'typeId', 'customFields', 'masked_num', 'design_year', 'season', 'material', 'volume'],
    )

    expected_output = spark_session.createDataFrame(
         [('R_6XXX4', '2019', 'FW', 'Grass', 4290),
         ('R_6XXX5', '2020', 'FW', 'Wood', 4290),
         ('R_6XXX6', '2021', 'SS', 'Wood', 5760),
         ('R_6XXX7', '2018', 'Custom', 'Grass', 5760),
         ('R_6XXX8', '2021', 'SS', 'Wood', 4500),                     
         ('R_6XXX9', '2021', 'SS', 'Wood', 4500)],
        ['sku', 'design_year', 'season', 'material', 'volume'],
    )

   
    # Actual output dataframe
    actual_output = d.create_dim_products(input)
    ...
    assert f"'Dim Products' table was created. Row count is 6" in caplog.text


def test_parse_json(spark_session, caplog):
    ...
    # Input and expected output dataframes
    input = spark_session.createDataFrame(
         [(2, 19.50, 10.00, 10, 22.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Grass"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2019"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "FW"}}', "R_6XXX4"),
         (3, 19.50, 10.00, 10, 22.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2020"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "FW"}}', "R_6XXX5"),
         (4, 30.00, 8.00, 10, 24.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX6"),
         (5, 30.00, 8.00, 10, 24.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Grass"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2018"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "Custom"}}', "R_6XXX7"),
         (6, 20.00, 15.00, 10, 15.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX8"),                     
         (7, 20.00, 15.00, 10, 15.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX9")],
        ["id", "height", "len", "typeId", "width", "customFields", "masked_num"],
    )

    expected_output = spark_session.createDataFrame(
         [(2, 19.50, 10.00, 10, 22.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Grass"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2019"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "FW"}}', "R_6XXX4", "2019"),
         (3, 19.50, 10.00, 10, 22.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2020"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "FW"}}', "R_6XXX5", "2020"),
         (4, 30.00, 8.00, 10, 24.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX6", "2021"),
         (5, 30.00, 8.00, 10, 24.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Grass"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2018"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "Custom"}}', "R_6XXX7", "2018"),
         (6, 20.00, 15.00, 10, 15.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX8", "2021"),                     
         (7, 20.00, 15.00, 10, 15.00, '{"63": {"name": "Material", "type": "Drop-Down List", "value": "Wood"}, "64": {"name": "Design Year", "type": "Drop-Down List", "value": "2021"}, "65": {"name": "Season", "type": "Drop-Down List", "value": "SS"}}', "R_6XXX9", "2021")],
        ["id", "height", "len", "typeId", "width", "customFields", "masked_num", "design_year"],
    )
    
    # Actual output dataframe
    actual_output = input.withColumn(field, d.parse_json(input.customFields, F.lit(key)))
